<div class="min-h-screen bg-gray-50 pb-24">
    ...
    <div class="px-4 py-6">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    @foreach ($savedCards as $card)
                        <div
                            class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 text-white relative overflow-hidden">
                            <!-- Card Pattern -->
                            ...
                            <div class="relative">
                                <div class="flex justify-between items-start mb-8">
                                    ...
                                    <button wire:click="deletePaymentMethod({{ $card['id'] }})"
                                ...
                                <div class="mb-6">
                                    <p class="text-2xl tracking-wider font-mono">•••• •••• ••••
                                        {{ substr($card['card_number'], -4) }}</p>
                                </div>
            ...
            <div class="bg-white rounded-xl border-2 border-gray-200 divide-y divide-gray-100">
                ...
                <div class="p-4 flex items-center gap-3">
                    <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                        <img src="{{ asset('images/icons/dana-icon.png') }}" alt="Aktivitas" class="w-6 h-6">
                    </div>
                    <div class="flex-1">
                ...
                <div class="p-4 flex items-center gap-3">
                    <div class="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                        <img src="{{ asset('images/icons/ovo-icon.png') }}" alt="Aktivitas" class="w-9 h-6">
                    </div>
                    <div class="flex-1">
                ...
                <div class="p-4 flex items-center gap-3">
                    <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
                        <img src="{{ asset('images/icons/gopay-icon.png') }}" alt="Aktivitas" class="w-10 h-6">
                    </div>
                    <div class="flex-1">
        ...
        <button wire:click="toggleAddCardModal"
            class="w-full border-2 border-dashed border-primary bg-primary text-primary-light rounded-xl p-4 font-semibold hover:bg-green-100 transition-colors">
            ...
            <div class="flex min-h-screen items-end justify-center p-0 md:items-center md:p-4">
                <div class="relative w-full max-w-md bg-white rounded-t-3xl md:rounded-2xl shadow-2xl" @click.stop>
                    ...
                    <div class="px-6 py-6">
                        <!-- Card Preview -->
                        <div
                            class="bg-gradient-to-br from-amber-800 to-amber-950 rounded-2xl p-6 text-white mb-6 relative overflow-hidden">
                            <div class="absolute -right-10 -top-10 w-40 h-40 bg-white/5 rounded-full"></div>
                        ...
                        <form class="space-y-4">
                            <div>
                                ...
                                <input type="text" placeholder="A.N. OTHER"
                    ...
                    <div class="px-6 py-4 border-t border-gray-200">
                        <button
                            class="w-full bg-green-700 text-white py-3 rounded-xl font-semibold hover:bg-green-800">
                            Save Card
                        </button>
                    </div>
                </div>
